...
public class HttpURLConnectionExample {
	...
	public static void main(String[] args) throws Exception {
		...
		URL obj = new URL(sendMessageURL);
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
		...
		String sendMessageURL = "http://newsms.designhost.in/index.php/smsapi/httpapi";
		URL obj = new URL(sendMessageURL);
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
		String urlParameters ="uname=vivek&password=123456&sender=SOLARR&receiver=9886652394&route=PSA&msgtype=1&sms=Mr.%20Ashwath%2C%20thank%20you%20for%20taking%20time%20out%20and%20providing%20valuable%20feedback";
		http.sendPost(sendMessageURL, urlParameters, con);
	...
	private void sendPost(String url, String params, HttpURLConnection con) throws Exception {		
		...
		con.setRequestProperty("Cookie", "ci_session=1297e0304d1b269a9e6cb008ab5135601d7c2ec1");
